...
import com.digitaldetox.dto.ValidationErrorResponseDTO;
...
public class ErrorHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDTO> handleEntityNotAuthorizedException(EntityNotAuthorizedException e) {
        log.warn("Not authorized. Message={}", e.getMessage());
        return ResponseEntity
    ...
    public ResponseEntity<ErrorResponseDTO> handleAppServerException(AppServerException e) {
        log.warn("Server error. Message={}", e.getMessage());
        return ResponseEntity
                .status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(new ErrorResponseDTO(e.getCode(), e.getMessage()));
    }
